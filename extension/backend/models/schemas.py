...
class ChangeItem(BaseModel):
    ...
    reasoning_trace: Optional[str] = Field(None, description="Detailed step-by-step reasoning for this change")
...
class WorkflowImpact(BaseModel):
    ...
    reasoning_trace: Optional[str] = Field(None, description="Detailed step-by-step reasoning for this impact")
...
class PRSummary(BaseModel):
    ...
    quality_score: int = Field(100, description="Quality score based on violations")
...
class ProfileCreate(BaseModel):
    ...
    custom_rules: Optional[str] = Field(None, description="Custom JSON/text rules for PR analysis")
...
class RepositoryMappingCreate(BaseModel):
    ...
    team_id: Optional[int] = Field(None, description="The ID of the team to use")
