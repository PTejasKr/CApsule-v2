...
from extension.backend.tests.integration.test_webhooks import generate_github_signature
...
@patch("extension.backend.routers.webhooks.brd_manager")
...
@patch("extension.backend.routers.webhooks.github_service")
@patch("extension.backend.routers.webhooks.brd_manager")
@patch("extension.backend.routers.webhooks.ai_engine")
@patch("extension.backend.routers.webhooks.insert")
async def test_ai_hallucination_shield_incident(mock_insert, mock_ai_engine, mock_brd_manager, mock_github_service):
    ...
    from extension.backend.models.schemas import PRSummary, WorkflowImpact, Severity
